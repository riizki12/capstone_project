...
<footer class="bg-gray-800 text-white pt-8 pb-4">
  <div class="container mx-auto px-4">
    <div class="flex flex-col md:flex-row justify-between">
      ...
      <!-- Bagian Kiri -->
      <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 md:mb-0">
        <!-- Tentang Kami -->
        <div>
          <h3 class="text-lg font-bold mb-4 text-green-400">Tentang Kami</h3>
          <p class="text-gray-300 text-sm">
            Yasmi adalah platform donasi online yang berkomitmen untuk membantu masyarakat kurang mampu dengan transparansi penuh.
          </p>
        </div>
    ...
    <div class="border-t border-gray-700 mt-8 pt-6 text-center text-gray-400 text-sm">
      <p>&copy; {{ date('Y') }} Yasmi - Donasi Online. All rights reserved.</p>
      <p class="mt-1">Project by Universitas Terbuka</p>
    </div>
  </div>
</footer>